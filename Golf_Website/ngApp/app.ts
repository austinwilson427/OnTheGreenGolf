namespace MyApp {
    ...
    angular.module("MyApp", ["ngRoute", "ngResource", "ui.bootstrap", "ui-rangeSlider", "ngAnimate", "angular-filepicker", "uiGmapgoogle-maps"]).config((
        $routeProvider: ng.route.IRouteProvider,
        $locationProvider: ng.ILocationProvider, filepickerProvider, uiGmapGoogleMapApiProvider: any) => {
